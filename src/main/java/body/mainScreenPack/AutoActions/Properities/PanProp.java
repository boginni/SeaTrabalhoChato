 ...
 * @author boginni
 */
public abstract class PanProp extends javax.swing.JPanel {

    /**
     * Creates new form PanProp
     */
    public PanProp() {
        initComponents();
    }

    public static PanProp getNullPanel() {
        return new PanProp() {
            @Override
    ...
    public abstract void setCurrentAction(AutomatedAction newAction);
    
    public abstract AutomatedAction getAction();
    /**
